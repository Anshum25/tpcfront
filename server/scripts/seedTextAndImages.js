...
var TextBlock_1 = require("../models/TextBlock");
...
var textBlocks = [
  ...
  { title: "Homepage Heading", value: "Welcome to Turning Point Community" },
  {
    ...
    value:
      "Empowering over  students across Gujarat through intellectually enriching platforms that foster leadership, critical thinking, and civic engagement.",
  },
  ...
  {
    title: "Interactions Section Subheading",
    value: "Explore our collaborative partnerships and Community engagements",
  },
  ...
  { title: "Our Supporters Button", value: "Our Supporters" },
  {
    ...
    value: "Start Your Journey to Leadership Excellence",
  },
  {
    title: "Signup Subheading",
    value:
      "Join over 10,000 students across Gujarat in our mission to foster leadership, critical thinking, and civic engagement through intellectually enriching experiences.",
  },
  { title: "Signup Benefits Title", value: "What you'll get:" },
  {
    title: "Signup Benefit 1",
    value: "Access to exclusive events and competitions",
  },
  {
    title: "Signup Benefit 2",
    value: "Networking with like-minded individuals",
  },
  ...
  {
    title: "Login Subheading",
    value:
      "Continue your path to excellence with access to exclusive events, networking opportunities, and leadership development programs.",
  },
  { title: "Login Welcome", value: "Welcome Back" },
  { title: "Login Button", value: "Sign in to your account to continue" },
  {
    title: "Signup Button",
    value: "Create your account and start your leadership journey",
  },
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            TextBlock_1.default.findOneAndUpdate(
              { title: block.title },
              { value: block.value },
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            Image_1.default.findOneAndUpdate(
              { title: img.title },
